...
class DataValidation:
    ...
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validationconfig: DataValidationConfig):
        try:
            self.data_ingestion_artifact = data_ingestion_artifact
            self.data_validationconfig = data_validationconfig
    ...
    def validate_all_files_exist(self) -> bool:
        try:
            ...
            for file in all_files:
                ...
                if file not in self.data_validationconfig.required_file_list:
                    validation_status = False
                    os.makedirs(self.data_validationconfig.data_validation_dir, exist_ok=True)
                    with open(self.data_validationconfig.validation_status_file_dir, 'w') as f:
